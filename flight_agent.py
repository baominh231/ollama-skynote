...
def run_flight_skill(user_query: str, api_key_from_ui: str = None):
    ...
    if extracted.get("action") == "general_question":
        return "Which destination are you looking for, and what is your intended travel date?"
    ...
    response = f" **Flight schedule from {origin_code} to {dest_code} on {flight_date}:**\n\n"
